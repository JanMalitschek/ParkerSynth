...
private:
	Image knob_pink = ImageFileFormat::loadFrom(BinaryData::Knob_Center_Pink_png, (size_t)BinaryData::Knob_Center_Pink_pngSize);
	Image knob_blue = ImageFileFormat::loadFrom(BinaryData::Knob_Center_Blue_png, (size_t)BinaryData::Knob_Center_Blue_pngSize);
	Image knob_grey = ImageFileFormat::loadFrom(BinaryData::Knob_Center_Grey_png, (size_t)BinaryData::Knob_Center_Grey_pngSize);
};